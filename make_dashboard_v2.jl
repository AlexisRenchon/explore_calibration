...
using ClimaAnalysis # won't be needed when locations in metadata
using ClimaLand # won't be needed when locations in metadata
using ClimaComms # won't be needed when locations in metadata
using ClimaCore # won't be needed when locations in metadata
...
eki_file = "ekifiles/eki_file.jld2"
prior_file = "ekifiles/priors.jl"
variable_file = "ekifiles/variables_land.jl"
